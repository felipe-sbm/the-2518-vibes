...
const Home = () => {
  return (
    <div class={style.home}>
        <img
          src="../../assets/anormalwebsite.webp"
    ...
    <p class={style.a}>
      ...
      vel corrupti aspernatur ratione harum ad et ullam labore iure voluptate
      optio obcaecati ea, alias nemo praesentium, nam repellat porro?
    </p>
    <p class={style.b}>
      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio saepe
      incidunt nulla, ut reiciendis sint repudiandae possimus repellendus et
      quis beatae dicta aliquid iste quibusdam? Assumenda dolore nam culpa
      asperiores.
    </p>
    <p class={style.c}>
    ...
    <p>
      ...
      ipsum obcaecati voluptas earum ducimus natus, officia tempora? Laboriosam
      voluptatem facilis, fugit dolor nam ad quo quos modi perferendis
      aspernatur.
    </p>
        <Libary />
      <section>
